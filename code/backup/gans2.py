...
class GAN(object):
    ...
    def _samples(self, session, num_points=10000, num_bins=100):
        ...
        # decision boundary ( integer division)
        db = np.zeros((num_points, 1))#db is the output of the discriminator when adding samples from the generator..
...
model_prueba = GAN(data = DataDistribution(), gen = GeneratorDistribution,
                    num_steps = 1200, batch_size =200, minibatch = True,
                    log_every = 200, anim_path = True)
model_prueba.train()
